! function () {
    ...
    class Fi {
        constructor(t) {
            this.DOM = {
                el: t
            }, this.DOM.link = this.DOM.el.querySelector(".menu__item-link"), this.DOM.marquee = this.DOM.el.querySelector(".marquee"), this.DOM.marqueeInner = this.DOM.marquee.querySelector(".marquee__inner-wrap"), this.animationDefaults = {
                duration: .6,
                ease: "expo"
            }, this.initEvents()
        }
    ...
    new class {
        constructor(t) {
            this.DOM = {
                el: t
            }, this.DOM.menuItems = this.DOM.el.querySelectorAll(".shop-moods-item"), this.menuItems = [], this.DOM.menuItems.forEach((t => this.menuItems.push(new Fi(t))))
        }
    }(document.querySelector(".shop-moods-item-wrap"))
}();